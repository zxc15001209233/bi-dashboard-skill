...
| 参考图/截图 | **复刻模式（结构同构，不承诺像素级）**：先选还原档；内容截图禁止抠皮；卡内分区是 P0、灯管是 P2；`inspect-source` 鉴定；原图 clip 认结构；写后 ref/proto 并排否则不得写通过 |
...
| 时间 | 说明 |
|---|---|
| 2026-09-01 | 交接须读对方 SKILL、未安装则停；混合文档只做大屏页；占位不等于接口契约 |
